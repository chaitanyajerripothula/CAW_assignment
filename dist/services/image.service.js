...
const imageToThumbnail = function (filename, callback) {
  ...
  sharp(path + `downloads/` + filename).resize({ height: 50, width: 50, fit: 'fill' }).toFile(_path + filename).then(function (newFileInfo) {
    callback(_path + filename);
  }).catch(function (err) {});
};

exports.download = download;
exports.imageToThumbnail = imageToThumbnail;